...
export const TOPICS: Record<Cat, Record<Lang, string[]>> = {
  ...
  exani: {
    es: [
      ...
      "Inglés (Diagnóstico B1)",
      "Ciencias de la Salud (Biología y Premedicina)",
      "Ingenierías y Física",
      "Administración y Economía",
      "Derecho y Ciencias Sociales",
      "Filosofía y Literatura",
      "Aritmética y Matemáticas Financieras",
      "Probabilidad y Estadística",
      "Simulador Completo EXANI-II (Ceneval 2025)",
    ],
    en: [
      "Reading Comprehension",
      "Indirect Writing",
      "Mathematical Thinking",
      "English (Diagnostic B1)",
      "Health Sciences (Biology & Premed)",
      "Engineering & Physics",
      "Business & Economics",
      "Law & Social Sciences",
      "Philosophy & Literature",
      "Arithmetic & Financial Math",
      "Probability & Statistics",
      "Full EXANI-II Simulator (Ceneval 2025)",
    ],
    fr: [
      "Compréhension de lecture",
      "Rédaction indirecte",
      "Pensée mathématique",
      "Anglais (Diagnostique B1)",
      "Sciences de la santé",
      "Ingénierie et physique",
      "Administration et économie",
      "Droit et sciences sociales",
      "Philosophie et littérature",
      "Arithmétique et maths financières",
      "Probabilités et statistiques",
      "Simulateur complet EXANI-II",
    ],
  },
  math: {
