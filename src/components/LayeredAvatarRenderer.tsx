...
const LAYER_POSITIONS: Record<string, LayerPosition> = {
  ...
  hair: { top: "0%", left: "5%", width: "90%", height: "100%" },
  top: { top: "0%", left: "5%", width: "90%", height: "100%" },
  bottom: { top: "0%", left: "5%", width: "90%", height: "100%" },
  shoes: { top: "0%", left: "5%", width: "90%", height: "100%" },
};
